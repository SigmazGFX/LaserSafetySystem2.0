...
//#define FLOWSENSORPIN 2 //Connect flow sensor signal output to this digital Pin (NOTE: this pin needs to be D2(INT0) if you wish to use inturrupts for flow calcs)
